...
class HistorialTrabajo2 extends StatefulWidget {
  const HistorialTrabajo2({super.key});

  @override
  State<HistorialTrabajo2> createState() => _HistorialTrabajo2State();
}

class _HistorialTrabajo2State extends State<HistorialTrabajo2> {
